...
Public Class wstipoarticulo
    ...
    Public Function GuardarDatos(ByVal nombre As String) As Boolean
        ...
        Dim StrEncabezado As String = "INSERT INTO TIPOARTICULO (tipolente,estado) VALUES ('" & nombre & "',1)"
    ...
    Public Function ActualizarDatos(ByVal nombre As String, ByVal id As Integer) As Boolean
        Dim result As Boolean = False
        Dim StrEncabezado As String = "UPDATE TIPOARTICULO SET tipoLente = '" & nombre & "' WHERE idTipoLente=" & id
        result = manipular.EjecutaTransaccion1(StrEncabezado)
        Return result
    End Function
