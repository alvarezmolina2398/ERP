...
function insertar(nombre) {
    $.ajax({
        type: 'POST',
        url: 'wsactividadempresa.asmx/GuardarDatos',
        data: '{ nombre : "' + nombre + '"}',
...
function actualizar(nombre, id) {
    $.ajax({
        type: 'POST',
        url: 'wsactividadempresa.asmx/ActualizarDatos',
...
function eliminar(id) {
    $.ajax({
        type: 'POST',
        url: 'wsactividadempresa.asmx/Eliminar',
        data: '{id: ' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function mostrarMarcas() {
    ...
    $.ajax({
        type: "POST",
        url: "wsactividadempresa.asmx/ObtenerDatos",
        data: '',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
